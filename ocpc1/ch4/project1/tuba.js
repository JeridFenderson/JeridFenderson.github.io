...
let acresComplete = false;
let cropsComplete = false;
let monthsComplete = false;
let fuelComplete = true;

/* global variables referencing sidebar h2 and p elements */
const messageHeadElement = document.getElementById("messageHead");
const messageElement = document.getElementById("message");

/* global variables referencing fieldset elements */
const acresFieldset = document.getElementsByTagName('fieldset')[0];
const cropsFieldset = document.getElementsByTagName('fieldset')[1];
const monthsFieldset = document.getElementsByTagName('fieldset')[2];
const fuelFieldset = document.getElementsByTagName('fieldset')[3];
